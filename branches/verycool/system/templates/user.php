			...
			<div id="profile2">
				<div id="profile_left">
					...
					<table cellpadding="0" cellspacing="3">
						<tr>
							<td class="contactparam"><img src="<?= $C->IMG_URL ?>design/cicons_username.gif" alt="" title="<?= htmlspecialchars($D->usr->fullname) ?>" /></td>
							<td class="contactvalue"><?= $D->usr->username ?></td>
						</tr>
						<?php if( !empty($D->usr_website) ) { ?>
						<tr>
							<td class="contactparam"><img src="<?= $C->IMG_URL ?>design/cicons_site.gif" alt="" title="<?= $this->lang('usr_left_cnt_site') ?>" /></td>
						...
						<div style="margin-left:4px;">
							<table cellspacing="4">
								...
								<?php $i=0; foreach($D->i->prs as $k=>$v) { $i++; ?>
									<td><img src="<?= $C->IMG_URL ?>design/ext_<?= $k ?>.gif" alt="<?= $this->lang('usr_info_'.$k) ?>" title="<?= $this->lang('usr_info_'.$k) ?>"></td>
						...
						<div style="margin-left:4px;">
							<table cellspacing="4">
								...
								<?php $i=0; foreach($D->i->ims as $k=>$v) { $i++; ?>
									<td><img src="<?= $C->IMG_URL ?>design/<?= $k ?>.gif" alt="<?= $this->lang('usr_info_'.$k) ?>" title="<?= $this->lang('usr_info_'.$k) ?>" /></td>
