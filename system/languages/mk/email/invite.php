<?php
	...
	(
		...
		'os_invite_email_subject'	=> 'Придружете се на #SITE_TITLE#',
		'os_invite_email_hello'		=> '#WHOM#,',
		'os_invite_email_message'	=> '#WHO# ве поканува да се придружите на #SITE_TITLE#.',
		'os_invite_email_regtext'	=> 'За да се зачлените, следете го линкот:',
		'os_invite_email_signature'	=> "Поздрав,\n#SITE_TITLE#",
	);
