...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
	<head>
		...
		<link href="<?= $C->IMG_URL ?>css/inside.css" type="text/css" rel="stylesheet" />
		<script type="text/javascript" src="<?= $C->IMG_URL ?>js/inside.js"></script>
		<script type="text/javascript" src="<?= $C->IMG_URL ?>js/inside_autocomplete.js"></script>
		<script type="text/javascript" src="<?= $C->IMG_URL ?>js/inside_postform.js"></script>
		<script type="text/javascript" src="<?= $C->IMG_URL ?>js/inside_posts.js"></script>
		<script type="text/javascript" src="<?= $C->IMG_URL ?>js/swfobject.js"></script>
		...
		<link href="<?= $C->IMG_URL.'design/favicon.ico' ?>" type="image/x-icon" rel="shortcut icon" />
				...
				<div id="postform" style="display:none;">
					<form name="post_form" action="" method="post" onsubmit="return false;">
						<div id="pf_posting" style="display:none;">
							<img src="<?= $C->IMG_URL ?>design/loading.gif" alt="" /><b><?= $this->lang('pf_msg_posting') ?></b>
						</div>
						<div id="pf_loading" style="display:none;">
							<img src="<?= $C->IMG_URL ?>design/loading.gif" alt="" /><b><?= $this->lang('pf_msg_loading') ?></b>
						</div>
							...
							<div id="attachboxcontent">
								<div id="attachboxcontent_link" style="display:none;">
									...
									<div id="attachboxcontent_link_ftr" class="submitattachment">
										<img src="<?= $C->IMG_URL ?>design/loading.gif" alt="" style="margin-bottom:2px;" />
