...
?>
					<div id="home_left">
						...
						<div id="homefltr">
							...
							<a href="<?= $C->SITE_URL ?>dashboard/tab:@me" class="item atme<?= $D->tab=='@me'?' onitem':'' ?>"><b></b><strong><?= $this->lang('dbrd_leftmenu_@me') ?></strong><span><small id="dbrd_tab_mention" style="<?= $D->tabs_state['@me']==0||$D->tab=='@me'?'display:none;':'' ?>"><?= $D->tabs_state['@me'] ?></small></span></a>
					...
					<div id="home_right">
						...
						<?php if( $this->network->id == 7 ) { ?>
							<!-- <div id="nycdbad">Join us for a live demo of <?= $C->OUTSIDE_SITE_TITLE ?>, our new secure microsocial platform, at booth #1217.</div> -->
							<div id="nyc_createnet">
								<div id="nyc_createnet2">
									<h3>Register a private network for your company</h3>
									<p>Start by adding your company e-mail address here:</p>
									<form method="post" action="<?= $C->OUTSIDE_SITE_URL ?>signup" />
										<input type="text" name="email" value="you@yourcompany.com" onfocus="if(this.value=='you@yourcompany.com'){this.value='';}" style="width:160px;" maxlength="100"  />
										<input type="submit" value="Go!" style="padding:1px;" />
									</form>
									<small>Company networks are private and secure. You must use a valid company e-mail address to create a new network. Don't try with your Gmail or Yahoo! Mail, it won't work.</small>
								</div>
							</div>
						<?php } ?>
