<?php
	...
	class cache_memcached
	{
		...
		{
			$this->memcached_host	= CACHE_MEMCACHE_HOST;
			$this->memcached_port	= CACHE_MEMCACHE_PORT;
			$this->keys_prefix	= CACHE_KEYS_PREFIX;
			$this->mc	= FALSE;
			$this->debug_mode	= defined('DEBUG_MODE') && DEBUG_MODE==TRUE;
